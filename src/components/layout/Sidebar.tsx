...
const Sidebar = () => {
  ...
  return (
    <div className="hidden p-5 border-r border-r-gray-200 bg-white dark:border-opacity-10 dark:bg-grayDarker lg:flex flex-col fixed top-0 left-0 bottom-0 w-[300px]">
      <a
        href="/"
